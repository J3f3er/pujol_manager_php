        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container py-5 caja_busqueda" id="caja_busqueda"></div>
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Servicios</h3>
                    <h6 class="text-dark mb-4"><?php require_once "fecha_dia_hora.php";?></h6>
                    <div class="row">
                        <div class="col col-lg-6">
                            
                            <?php
                             if($nivel == 6 || $nivel == 5 || $nivel == 3)
                             {
                                echo '<button type="button" class="btn btn-primary text-white" id="btn_reg_serv"><strong>Registrar Servicios</strong></button> ';
                                echo '<button type="button" class="btn btn-success text-dark"><strong>Excel Servicios</strong></button>'; 
                             } 
                            ?>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <!-- <button type="button" class="btn btn-info w-100 h-100 text-center text-white" cantidad="" serv="<?=$servicios["pm_id"]?>" nombre="<?=$servicios["pm_nombre_servicio"]?>" precio="<?=$servicios["pm_precio"]?>" user="<?=$id?>" id="btn_add_cart">Añadir al carrito</button> -->
