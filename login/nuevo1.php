...
$stmt->bindParam(':inicio', ($pagina_actual - 1) * $registros_por_pagina, PDO::PARAM_INT);
...
$pagination = '';
if ($pagina_actual > 1) {
    $pagination .= '<a class="pagination-item" href="?pagina=' . ($pagina_actual - 1) . '"><img src="icon_arrow-left.svg" /><span>Previo</span></a>';
}
...
if ($pagina_actual < $num_paginas) {
    $pagination .= '<a class="pagination-item" href="?pagina=' . ($pagina_actual + 1) . '"><span>Siguiente</span><img src="icon_arrow-right.svg" /></a>';
}
