        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Equipo</h3>
                    ...
                    <div class="card shadow" id="tabla-1">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Información del Empleado</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                    ...
                    <div class="card shadow" id="tabla-2">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Información del Servicio</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 text-nowrap">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        <?php foreach($result_servicios as $result3){
                                                if(!empty($result3['pm_avatar'])){
                                                    /* header('Content-Type: image/jpeg'); */
                                                    $image64 = base64_encode($result3['pm_avatar']);
                                        ?>
                                        <tr>
                                        <td><img class="rounded-circle me-2" width="30" height="30" src="data:image/jpeg;base64,<?php echo $image64;?>"></td>
                                            ...
                                            <td><?=$result3['pm_id']?></td>
                                            <td><?=$result3['pm_nombre_servicio']?></td>
                                            <td><?=$result3['pm_descrition_servicio']?></td>
                                            <td><?=$result3['pm_precio']?></td>
                                            <td><?php if($result3['pm_moneda'] == 'USD') { echo '$'; } elseif($result3['pm_moneda'] == 'EUR') { echo '€'; } elseif($result3['pm_moneda'] == 'B') { echo 'Bs'; } ?></td>
                                        </tr>
                                        <?php } ?>
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            <?php
                                                if ($page_servicios == 1) {
                                                    echo '<li class="page-item disabled"><a class="page-link" aria-label="Previous" href="?page_servicios=' . $page . '#Servicios"><span aria-hidden="true">«</span></a></li>';
                                                } else {
                                                    $prev = $page_servicios - 1;
                                                    echo '<li class="page-item"><a class="page-link" aria-label="Previous" href="?page_servicios=' . $page . '#Servicios"><span aria-hidden="true">«</span></a></li>';
                                                }
                                                ?>
                                                </span></a></li>
                                                <?php
                                                for ($i = 1; $i <= $page_servicioss; $i++) {
                                                    if ($i == $page_servicios) {
                                                        echo '<li class="page-item active"><a class="page-link" href="?page_servicios='.$i.'#Servicios">'.  $i .'</a></li>';
                                                    } else {
                                                        echo ' <li class="page-item"><a class="page-link" href="?page_servicios='.$i.'#Servicios">' . $i . '</a></li> ';
                                                    }
                                                }
                                                
                                                if ($page_servicios == $page_servicioss) {
                                                    echo '<li class="page-item disabled"><a class="page-link" aria-label="Next" href="?page_servicios=' . $i . '#Servicios"><span aria-hidden="true">»</span></a></li>';
                                                } else {
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <td><img class="rounded-circle me-2" width="30" height="30" src="data:image/jpeg;base64,<?php echo $image64;?>"></td>
                                            <?php }else{ echo '<td><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/avatar5.jpeg">Airi Satou</td>'; } ?>
                                            <td><?php echo $usuario['pm_id']; ?></td>
                                            <td><?php echo $usuario['pm_nombre']; ?></td>
                                            <td><?php echo $usuario["pm_apellido"]; ?></td>
                                            <td><?php echo $usuario["pm_correo"]; ?></td>
                                            <!-- <td><?php //echo $usuario["pm_edad"]; ?></td> -->
                                            <td><?php echo $usuario["pm_area_tel"] . '' .$usuario["pm_num_tel"]; ?></td>
                                            <td><?php if($usuario["pm_nivel"] == '1') { echo 'Cliente'; }elseif($usuario["pm_nivel"] == '2') { echo 'Recaudador'; } elseif($usuario["pm_nivel"] == '3'){ echo 'Talento'; }elseif($usuario["pm_nivel"] == '4'){ echo 'Administrador'; }elseif($usuario["pm_nivel"] == '5'){ echo 'Master'; } ?></td>
                                            <td>
                                                <div class="btn-group" role="group">
